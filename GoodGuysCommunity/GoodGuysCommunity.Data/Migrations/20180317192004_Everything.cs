    ...
    public partial class Everything : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceFolderChild", x => new { x.ChildId, x.FolderId });
                    table.ForeignKey(
                        name: "FK_ResourceFolderChild_ResourceFolders_ChildId",
                        column: x => x.ChildId,
                        principalTable: "ResourceFolders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResourceFolderChild_ResourceFolders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "ResourceFolders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Resources_ResourceFolders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "ResourceFolders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceFolderChild_FolderId",
                table: "ResourceFolderChild",
                column: "FolderId");
